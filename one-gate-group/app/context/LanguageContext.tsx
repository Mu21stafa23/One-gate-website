...
const translations = {
  en: {
    ...
    divider: {
      ...
      logisticsExport: 'Logistics & Export',
      partnershipInvestment: 'Partnership & Investment',
  ...
  ar: {
    ...
    divider: {
      ...
      sector: 'القطاعات',
      partner: 'الشركاء',
      whyChooseUs: 'لماذا الاستثمار معنا؟',
      products: 'منتجاتنا',
      qualityProcessing: 'الجودة والمعالجة',
      logisticsExport: 'التصدير والخدمات اللوجستية',
      partnershipInvestment: 'نموذج الشراكة والاستثمار',
      locations: 'مواقعنا',
      contactUs: 'اتصل بنا',
      whoWeAre: 'من نحن',
      ourVision: 'رؤيتنا',
