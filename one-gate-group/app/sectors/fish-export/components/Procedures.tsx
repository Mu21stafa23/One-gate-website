...
import { proceduresData } from '@/app/sectors/cold-storage/data/proceduresData';
...
export default function Procedures() {
  ...
  return (
    <section className="relative isolate overflow-hidden py-16 sm:py-24 bg-white dark:bg-gray-900" dir={dir}>
