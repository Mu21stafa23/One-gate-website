    ...
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      >
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div>
            ...
            <div className="mt-2.5">
              <input
                ...
                required
                className="block w-full rounded-md bg-gray-50 px-3.5 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500"
              />
            </div>
          </div>
          <div>
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <div className="flex rounded-md bg-gray-50 outline-1 -outline-offset-1 outline-gray-300 has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-indigo-500">
      ...
      <div className="mt-16 flex justify-center items-center gap-8">
        ...
        >
          ...
          <span className="text-sm font-medium text-gray-300">Telegram</span>
        </a>
        ...
        <a
          ...
          className="flex flex-col items-center gap-2 hover:scale-110 transition-transform"
        >
          <div className="w-16 h-16 bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 rounded-full flex items-center justify-center">
            <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
